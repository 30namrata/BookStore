    ...
    return (
        <>
            <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 
                ${sticky ? "sticky-navbar  bg-base-200 shadow-md transition-all duration-300 ease-in-out" : ""}`}>
                <div className="navbar bg-base-100 ">
                    ...
                    <div className="navbar-end space-x-2">
                        ...
                        <div className="hidden md:block">
                            <label className=" px-3 py-1 border rounded-md flex container items-center gap-2">
                                ...
                                <input type="text" className="outline-none" required placeholder="Search" />
                            </label>
